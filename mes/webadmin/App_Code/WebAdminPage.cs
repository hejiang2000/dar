...
namespace System.Web.Administration {
    ...
    public sealed class WebAdminModule : IHttpModule {
        ...
        private void SetSessionVariables(HttpApplication application) {
            ...
            string defaultPhysicalPath = string.Empty;
            ...
            defaultPath = paths[0];
            defaultPhysicalPath = paths[1];

            if ((String.IsNullOrEmpty(queryStringAppPath) && applicationPath == null && defaultPath == null) ||
               (String.IsNullOrEmpty(queryStringApplicationPhysicalPath) && applicationPhysicalPath == null && defaultPhysicalPath == null))
            {
            ...
            } else if (!String.IsNullOrEmpty(defaultPhysicalPath)) {
                setAppPhysPath = defaultPhysicalPath;
            }
